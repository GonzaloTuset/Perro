...
const Detail = () => {
  ...
  return (
    ...
    <img src={
      dogDetail.image ? 
      (dogDetail.image) : dogDetail.reference  ?
       (`https://cdn2.thedogapi.com/images/${dogDetail.reference}.jpg`) : 
       ('https://upload.wikimedia.org/wikipedia/commons/thumb/e/e5/Missing_dog_photo.svg/1165px-Missing_dog_photo.svg.png')} alt='img'/>
